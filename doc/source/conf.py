...
copyright = u'2012, Javier Diaz, Fugang Wang, Gregor von Laszewski'
...
version = futuregrid_move.VERSION
# The full version, including alpha/beta/rc tags.
release = futuregrid_move.RELEASE
...
htmlhelp_basename = 'FutureGridMovedoc'
...
latex_documents = [
  ('index', 'FutureGrid.tex', u'FutureGrid Move Documentation',
...
man_pages = [
    ('index', 'futuregrid_move', u'FutureGrid Move Documentation',
